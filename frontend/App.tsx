...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (activeNav === "Vaults")                              return <VaultsBrowserPage onOpenVault={() => setActiveTab("Overview")} />;
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: colors.surface }}>
        {!isMobile && <Sidebar activeNav={activeNav} onNavChange={handleNavChange} />}
        <main style={{
        ...
        {isMobile && <MobileNav activeNav={activeNav} onNavChange={handleNavChange} />}
        <AmbientGlow />
      </div>
    </>
  );
